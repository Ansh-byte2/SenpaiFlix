...
const AnimeDetail = () => {
  ...
  if (!anime) return <div className="p-4 text-white">Loading...</div>;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-4">
          <p className="text-sm text-gray-400">
            Home &bull; {anime.type} &bull; {anime.title}
          </p>
          ...
          <p className="text-sm mt-4 text-gray-300">
            Senpai  is the best site to watch <strong>{anime.title}</strong> SUB
            online, or you can even watch <strong>{anime.title}</strong> DUB in
        ...
        <div className="w-72 flex-shrink-0 bg-gray-800 bg-opacity-50 backdrop-blur-md rounded-xl p-6 text-sm space-y-3 border border-gray-700">
          ...
          <div>
            ...
            {anime.synonyms.length > 0 ? anime.synonyms.join(", ") : "N/A"}
          </div>
          <div>
