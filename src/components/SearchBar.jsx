...
const SearchBar = () => {
  ...
  return (
    <div className="relative flex flex-col w-80" style={{ zIndex: 9999, width:"31rem" }}>
      ...
      {results.length > 0 && (
        <ul className="absolute bg-[#1a1a2e] text-white w-full max-w-full rounded max-h-[60vh] overflow-auto shadow-lg" style={{ zIndex: 10000, marginTop: '4.25rem' }}>
          {results.map((anime) => (
            <li
              key={anime.mal_id}
              onClick={() => {
            ...
            >
              ...
              <div className="flex flex-col flex-grow">
                <span className="font-semibold text-white">{anime.title_english}</span>
