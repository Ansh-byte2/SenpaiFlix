  ...
  return (
    <nav className="bg-[#0f0f1b] p-4 flex justify-between items-center fixed w-full top-0 z-50 shadow-md border-b border-gray-800">
      ...
      <ul className="flex gap-8 text-white font-semibold text-base select-none mr-8">
        ...
        <li>
          <Link to="/movies" className="hover:text-pink-400 transition duration-300">
            Movies
          </Link>
        </li>
        <li>
          <Link to="/tv-series" className="hover:text-pink-400 transition duration-300">
            TV Series
          </Link>
        </li>
        <li>
          <Link to="/most-popular" className="hover:text-pink-400 transition duration-300">
            Most Popular
          </Link>
        </li>
        <li>
          <Link to="/top-airing" className="hover:text-pink-400 transition duration-300">
            Top Airing
          </Link>
        </li>
      </ul>
